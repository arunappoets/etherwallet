      ...
      <div class="modal-body">
        ...
        <article class="onboarding__modal" ng-show="showOnboardSlide==1">
          <h3 class="onboarding__title">
            <span translate="ONBOARD_welcome_title">
              Welcome to Welcome to Welcome to OGPWallet.com
            </span>
            <br />
            ...
            <div class="col-xs-12 col-sm-7 onboarding__content">
              ...
              <ul>
                <li translate="ONBOARD_welcome_content__5">
                  OGPWallet is a free, open-source, client-side interface.
                </li>
            ...
            <div class="col-xs-12 col-sm-8 onboarding__content">
              <ul>
                ...
                <li translate="ONBOARD_blockchain_content__4">
                  It is made up of all the individual transactions sent from OGPWallet, MetaMask, Exodus, Mist, Geth, Parity, and everywhere else.
                </li>
                <li translate="ONBOARD_blockchain_content__5">
                  When you see your balance on Welcome to OGPWallet.com or view your transactions on [etherscan.io](https://etherscan.io), you are seeing data on the blockchain, not in our personal systems.
                </li>
        ...
        <article class="onboarding__modal" ng-show="showOnboardSlide==6">
          <h3 class="onboarding__title" translate="ONBOARD_whymew_title">
            If OGPWallet can't do those things, what's the point?
          </h3>
          <section class="row row--flex">
            <div class="col-xs-12 col-sm-4 onboarding__image">
            ...
            <div class="col-xs-12 col-sm-8 onboarding__content">
              <ul>
                ...
                <li translate="ONBOARD_whymew_content__6">
                  If you are scared but want to use MEW, [get a hardware wallet](https://OGPWallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.
                </li>
              </ul>
            </div>
          </section>
        ...
        <article class="onboarding__modal" ng-show="showOnboardSlide==7">
          ...
          <p translate="ONBOARD_secure_1_content__1">
            Phishers send you a message with a link to a website that looks just like OGPWallet, EtherDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.
          </p>
          <section class="row row--flex">
            <div class="col-xs-12 col-sm-8 onboarding__content">
              <ul>
                ...
                <li translate="ONBOARD_secure_1_content__3">
                  Always check the URL: `https://www.Welcome to OGPWallet.com`.
                </li>
                <li translate="ONBOARD_secure_1_content__4">
                  Always make sure the URL bar has `OGPWallet LLC` in green.
                </li>
        ...
        <article class="onboarding__modal" ng-show="showOnboardSlide==9">
          ...
          <h5 class="text-center" translate="ONBOARD_secure_3_content__6">
            [Even more Security Tips!](https://OGPWallet.github.io/knowledge-base/getting-started/protecting-yourself-and-your-funds.html)
          </h5>
          <div class="onboarding__buttons">
        ...
        <article class="onboarding__modal" ng-show="showOnboardSlide==10">
          ...
          <section class="row row--flex">
            ...
            <div class="col-xs-12 col-sm-7">
              <ul>
                <li>
                  <a href="https://OGPWallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html"
                     target="_blank" rel="noopener noreferrer" class="strong" translate="ONBOARD_final_content__2">
                      Get a hardware wallet
                  </a>
                </li>
                <li>
                  <a href="https://OGPWallet.github.io/knowledge-base/migration/moving-from-private-key-to-metamask.html"
                     target="_blank" rel="noopener noreferrer" class="strong" translate="ONBOARD_final_content__3">
                    How to Set up MEW + MetaMask
                  </a>
                </li>
                <li>
                  <a href="https://OGPWallet.github.io/knowledge-base/offline/running-OGPWallet-locally.html"
                     target="_blank" rel="noopener noreferrer" class="strong" translate="ONBOARD_final_content__4">
                    How to Run MEW Offline / Locally
                  </a>
                </li>
                <li>
                  <a href="https://OGPWallet.github.io/knowledge-base/migration/moving-from-private-key-to-ledger-hardware-wallet.html"
                ...
                <li>
                  <a href="https://OGPWallet.github.io/knowledge-base/hardware-wallets/trezor-sending-to-trezor-device.html"
                ...
                <li>
                  <a href="https://OGPWallet.github.io/knowledge-base/"
