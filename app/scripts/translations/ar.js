...
tx_Summary                  : 'During times of high volume (like during ICOs) transactions can be pending for hours, if not days. This tool aims to give you the ability to find and "cancel" / replace these TXs. ** This is not typically something you can do. It should not be relied upon & will only work when the TX Pools are full. [Please, read about this tool here.](https://OGPwallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html)**',
...
tx_notFound_4               : 'Please use the dropdown in the top-right & select a different ETH node (e.g. `ETH (Etherscan.io)` or `ETH (Infura.io)` or `ETH (OGPwallet)`) and check again.',
...
tx_FoundOnChain_3           : '**If you do not see any errors, your transaction was successfully sent.** Your ETH or Tokens are where you sent them. If you cannot see this ETH or Tokens credited in your other wallet / exchange account, and it has been 24+ hours since you sent, please [contact that service](https://OGPwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Send them the *link* to your transaction and ask them, nicely, to look into your situation.',
...
GEN_Help_12                 : 'Use it to unlock your wallet via OGPwallet (or Mist, Geth, Parity and other wallet clients.) ',
...
TXFEE_Desc                  : 'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> ETH here](https://www.OGPwallet.com/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Free, open-source, client-side interface for generating Ethereum wallets &amp; more. Interact with the Ethereum blockchain easily &amp; securely. Double-check the URL ( OGPwallet.com ) before unlocking your wallet.',
...
sidebar_donation            : 'OGPwallet is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. We are just two people trying to change the world. Help us? ',
sidebar_donate              : 'تبرع ',
sidebar_thanks              : 'شكرا!!! ',
...
ADD_Ledger_0a               : 'You must access OGPwallet via a secure(SSL / HTTPS) connection to connect.',
ADD_Ledger_0b               : 'Re-open OGPwallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'If you want to use this wallet with your OGPwallet CX in the future, you will need to manually re-add it using the private key/JSON and password. ',
...
NODE_Warning                : 'Your node must be HTTPS in order to connect to it via OGPwallet.com. You can [download the OGPwallet repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Name',
NODE_Port                   : 'Node Port',
...
ADD_Ledger_0a               : 'Réouvrir OGPwallet sur une connexion sécurisée (SSL) ',
ADD_Ledger_0b               : 'Réouvrir OGPwallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
x_Trezor                    : 'TREZOR ',
ADD_Trezor_scan             : 'Connexion au TREZOR ',
ADD_Trezor_select           : 'Ceci est une _seed_ TREZOR ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Réouvrir OGPwallet sur une connexion sécurisée (SSL) ',
ADD_DigitalBitbox_0b        : 'Réouvrir OGPwallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
...
GETH_GasLimit                   :  '(geth-03) Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://OGPwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)',
...
TranslatorName_1            : '[bstashio](https://www.OGPwallet.com/?gaslimit=21000&to=0xD8FE791535Ad85D2b0E76e603443C1b39107729F&value=1.0#send-transaction) · ',
