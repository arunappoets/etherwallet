...
tx_notFound_4               : 'Utilitza el menú desplegable a la part superior dreta i selecciona un node ETH diferent (p. Ex. `ETH (Etherscan.io)` o `ETH (Infura.io)` o `ETH (OGPWallet)`)  i torna-ho a comprovar.',
...
tx_FoundOnChain_3           : '**Si no veus cap error, la teva transacció s\'ha enviat amb èxit.** El teu ETH o Tokens són on els has enviat. Si no pots veure aquest ETH o Tokens a la teva cartera / compte de bescanvi, i han passat més de 24 hores des de l\'enviament, si us plau [contacta amb aquest servei](https://OGPWallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Envia *l\'enllaç* de la teva transacció si demana amablement que investiguin.',
...
GEN_Help_12                 : 'Utilitza\'l per desbloquejar la teva cartera amb OGPWallet (o Mist, Geth, Parity i altres clients de carteres.) ',
...
TXFEE_Desc                  : 'La comissió per la TX es paga als miners per incloure la teva TX en un block. És el `límit de gas` * `preu del gas`. [Pots convertir GWEI -> ETH aquí](https://www.OGPWallet.com/helpers.html)',
...
sidebar_donation            : 'OGPWallet és un servei lliure i de codi obert, dedicat a la teva privacitat i seguretat. Com més donacions rebem, més temps invertim creant noves funcions, escoltant els vostres comentaris i oferint-vos el que voleu. Només som dues persones que intentem canviar el món. Ens ajudes? ',
sidebar_donate              : 'Dóna ',
...
ADD_Ledger_0a               : 'Has d\'accedir a OGPWallet utilitzant una connexió segura (SSL / HTTPS). ',
ADD_Ledger_0b               : 'Torna a obrir OGPWallet utilitzant [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Torna a obrir OGPWallet utilitzant una connexió segura (SSL) ',
ADD_DigitalBitbox_0b        : 'Torna a obrir OGPWallet utilitzant [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Si vols utilitzar aquesta cartera amb OGPWallet CX en el futur, hauràs de tornar a afegir-la manualment utilitzant la clau privada/JSON i contrasenya. ',
...
NODE_Warning                : 'El teu node ha de ser HTTPS per tal de poder-t\'hi connectar utilitzant OGPWallet.com. Pots [descarregar-te el repo de OGPWallet i executar-lo localment](https://github.com/kvhnuke/etherwallet/releases/latest) per connectar-te a qualsevol node. O, obtén un certificat SSSL gratuït amb [LetsEncrypt](https://letsencrypt.org/)',
...
ERROR_35                        :  '(error_36) L\'adreça introduïda no s\'ha comprovat mitjantçant checksum. <a href="https://OGPWallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> Més informació</a> (Input address is not checksummed. <a href="https://OGPWallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer">What does that mean?</a>)',
...
PARITY_InvalidGasLimit          :  "(parity-05) El gas proporcionat és més enllà del límit. (Supplied gas limit is beyond limit. Try lowering the gas limit to 21000. [Learn More.](https://OGPWallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html))",
...
PARITY_Old                      :  "(parity-07) El nonce de la transacció és massa baix. Proveu d'augmentar-lo. (There is already a transaction with this [nonce](https://OGPWallet.github.io/knowledge-base/transactions/what-is-nonce.html). Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://OGPWallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html).)",
