...
tx_Summary                  : 'Pendant des périodes de volume important (comme pendant les ICOs les transactions peuvent rester en attente durant des heures, voire des jours. Cet outil cherche à vous donner la possibilité de trouver et d\'annuler / remplacer ces transactions. **Ce n\'est pas quelque chose de normalement faisable et vous ne devriez pas vous y fier. Cela ne marchera que lorsque les files d\'attente de transactions seront pleines. [Nous vous recommandons d\'en lire plus sur cet outil ici.](https://OGPWallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html)**',
...
tx_notFound_4               : 'Veuillez utiliser le menu déroulant en haut à droite & sélectionner un nœud ETH différent (par ex. `ETH (Etherscan.io)`, `ETH (Infura.io)` ou `ETH (OGPWallet)`) puis revérifiez.',
...
tx_FoundOnChain_3           : '**Si vous ne voyez pas d\'erreur, votre transaction a été envoyée avec succès.** Vos ETH ou Tokens sont à l\'endroit où vous les avez envoyés. Si vous ne voyez pas ces ETH ou Tokens dans votre autre portefeuille ou compte de plateforme de change, et si cela fait plus de 24 heures, veuillez [contacter ce service](https://OGPWallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Envoyez-leur le *lien* vers votre transaction et demandez, poliment, un examen de votre situation.',
...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec OGPWallet (ou Mist, Geth, Parity et autres clients.) ',
...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `GAS limite` * le `prix du GAS`. [Vous pouvez convertir GWEI -> ETH ici.](https://www.OGPWallet.com/helpers.html)',
...
MYWAL_Content_3             : 'Si vous voulez utiliser ce portefeuille avec OGPWallet CX à l\'avenir, vous devrez le rajouter manuellement en utilisant la clé privée / fichier JSON et le mot de passe.',
...
ADD_Ledger_0a               : 'Rouvrir OGPWallet sur une connexion sécurisée (SSL)',
ADD_Ledger_0b               : 'Rouvrir OGPWallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
ADD_DigitalBitbox_0a        : 'Rouvrir OGPWallet sur une connexion sécurisée (SSL)',
ADD_DigitalBitbox_0b        : 'Rouvrir OGPWallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
NODE_Warning                : 'Votre nœud doit être en HTTPS pour vous y connecter via OGPWallet.com. Vous pouvez [télécharger OGPWallet et le lancer localement](https://github.com/kvhnuke/etherwallet/releases/latest) pour vous connecter à un nœud quelconque, ou obtenir un certificat SSL gratuit via [LetsEncrypt](https://letsencrypt.org/)',
...
ERROR_35                    : '(error_36) Input address is not checksummed. <a href="https://OGPWallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer">What does that mean?</a> L\'adresse d\'entrée n\'a pas de somme de contrôle. <a href="https://OGPWallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener">Cliquez ici pour plus d\'infos</a>.',
...
GETH_Balance                : '(geth-01) Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more ETH to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://OGPWallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html). Solde insuffisant',
...
GETH_GasLimit               : '(geth-03) Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://OGPWallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html). Limite de Gas dépassée',
GETH_InsufficientFunds      : '(geth-04) Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more ETH to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://OGPWallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html). Fonds insuffisants pour (Gas * prix) + valeur',
...
GETH_Nonce                  : '(geth-08) This TX\'s [nonce](https://OGPWallet.github.io/knowledge-base/transactions/what-is-nonce.html) is too low. Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://OGPWallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html). Nonce trop bas',
...
PARITY_AlreadyImported      : "(parity-01) A transaction with the same hash was already imported. It was probably already broadcast. To avoid duplicate transactions, check your address on [etherscan.io](https://etherscan.io) & wait 10 minutes before attempting to send again. [Learn More.](https://OGPWallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html). Une transaction portant la même empreinte (_hash_) a déjà été importée.",
PARITY_GasLimitExceeded     : "(parity-02) Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://OGPWallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html). Le coût de la transaction excède la limite en Gas courante (limite : {}, coût : {}). Essayez de réduire le Gas fourni.",
PARITY_InsufficientBalance  : "(parity-03) Insufficient balance. The account you tried to send transaction from does not have enough funds. If you believe this is in error, try using the 'Send Entire Balance' button, or pressing generate again. Required (d+) and got: (d+). [Learn More.](https://OGPWallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html). Fonds insuffisants. Le compte d'où vous essayez d'envoyer une transaction ne possède pas assez de fonds (requis : {}, disponibles : {}).",
PARITY_InsufficientGasPrice : "(parity-04) There is another transaction with same nonce in the queue, or the transaction fee is too low. Try incrementing the nonce by clicking the Generate button again. [Learn More.](https://OGPWallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html). Les frais de transaction sont trop bas. Ils ne satisfont pas au minimum de votre nœud (minimum : {}, frais : {}). Essayez d\'augmenter les frais.",
PARITY_InvalidGasLimit      : "(parity-05) Supplied gas limit is beyond limit. Try lowering the gas limit to 21000. [Learn More.](https://OGPWallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html). Le Gas fourni dépasse la limite.",
PARITY_LimitReached         : "(parity-06) There are too many transactions in the queue. Your transaction was dropped due to limit. Try increasing the gas price. [Learn More.](https://OGPWallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html). Il y a trop de transactions en file d\'attente. Votre transaction a été abandonnée en raison de cette limite. Essayez d\'augmenter les frais.",
PARITY_Old                  : "(parity-07) There is already a transaction with this [nonce](https://OGPWallet.github.io/knowledge-base/transactions/what-is-nonce.html). Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://OGPWallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html). Le nonce de la transaction est trop bas. Essayez d\'incrémenter le nonce.",
PARITY_TooCheapToReplace    : "(parity-08) TX Fee is too low. It does not satisfy your node's minimal fee (minimal: (d+), got: (d+)). Try increasing the gas price and/or gas limit. [Learn More.](https://OGPWallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html). Les frais de transaction sont trop bas. Il y a une autre transaction avec le même nonce en file d\'attente. Essayez d\'augmenter les frais ou d\'incrémenter le nonce.",

/* Tranlsation Info */
translate_version           : '0.4',
Translator_Desc             : 'Merci à nos traducteurs',
TranslatorName_1            : '[Simon P](https://www.OGPWallet.com/?gaslimit=21000&to=0x89a18eE46b5aabC62e94b1830881887D04C687f3&value=1.0#send-transaction) ·',
...
HELP_Desc                   : 'Il manque quelque chose ? Vous avez d\'autres questions ? [Contactez-nous](mailto:support@OGPWallet.com), et non seulement nous allons vous répondre, mais nous mettrons aussi à jour cette page afin qu\'elle soit plus utile à tout le monde à l\'avenir !',
HELP_Remind_Title           : 'Quelques rappels :',
HELP_Remind_Desc_1          : '**Ethereum, OGPWallet.com & OGPWallet CX, ainsi que certaines des bibliothèques Javascript que nous employons sont en cours de développement.** Bien que nous les ayons testés intensivement et que des dizaines de milliers de portefeuilles aient été créés avec succès dans le monde entier, il existe toujours une faible possibilité qu\'un incident se produise, conduisant à la perte de vos ethers. N\'investissez pas plus que ce que vous pouvez vous permettre de perdre, et restez toujours prudents. En cas d\'accident, nous en serons désolés mais **nous ne sommes pas responsables d\'une éventuelle perte d\'ether**.',
HELP_Remind_Desc_2          : 'OGPWallet.com & OGPWallet CX ne sont pas des "portefeuilles web". Vous ne créez pas un compte, vous ne déposez pas votre ether chez nous. Aucune donnée ne sort de votre ordinateur ou de votre navigateur. Nous vous facilitons la création, la sauvegarde et l\'accès à vos informations ainsi que l\'interaction avec le blockchain.',
...
HELP_2b_Title               : '2b) Comment puis-je gérer en toute sécurité un stockage hors ligne avec OGPWallet ?',
...
HELP_3_Desc_3               : 'Naviguez vers la page Visualisation d\'un portefeuille" de OGPWallet.com.',
...
HELP_4CX_Title              : '4) Comment puis-je envoyer de l\'Ether avec OGPWallet CX ?',
...
HELP_5_Title                : '5) Comment puis-je lancer OGPWallet.com hors ligne (en local) ?',
HELP_5_Desc_1               : 'Vous pouvez lancer OGPWallet.com sur votre ordinateur au lieu de passer par les serveurs GitHub. Vous pouvez générer un portefeuille en restant totalement hors ligne et envoyer des transactions depuis la page "Transaction hors ligne".',
HELP_5_Desc_7               : 'OGPWallet.com tourne maintenant complètement sur votre ordinateur.',
HELP_5_Desc_8               : 'Au cas où cela ne vous est pas familier, vous devez conserver l\'intégralité du dossier pour faire tourner le site web et non uniquement `index.html`. Ne touchez à rien, ne déplacez rien dans le dossier. Si vous stockez une sauvegarde du repo OGPWallet pour l\'avenir, nous vous recommandons de ne stocker que le ZIP afin d\'être sûr que le contenu du dossier restera intact.',
HELP_5_Desc_9               : 'Comme nous améliorons constamment OGPWallet.com, nous vous recommandons de mettre régulièrement à jour votre version de sauvegarde.',
...
HELP_8_Desc_1               : 'OGPWallet n\'est pas un portefeuille web. Vous n\'avez pas de compte dessus et rien n\'est jamais stocké sur nos serveurs. Ce n\'est qu\'une interface qui vous permet d\'interagir avec le blockchain.',
HELP_8_Desc_2               : 'Si OGPWallet.com venait à être hors ligne, vous devrez trouver un autre moyen (comme Geth ou Ethereum Wallet / Mist) pour faire la même chose. Mais vous n\'aurez pas à "récupérer" votre Ether depuis OGPWallet parce qu\'il ne se trouve pas dans OGPWallet. Il est chez vous, dans le portefeuille que vous avez généré par notre site.',
...
HELP_8CX_Desc_2             : 'Cela dit, il est **très important** que vous sauvegardiez toutes les données de tous les portefeuilles générés par OGPWallet CX. De cette manière, si quoi que ce soit arrivait à OGPWallet CX ou à votre ordinateur, vous conserveriez toutes les informations nécessaires pour accéder à votre Ether. Voir #2a pour la sauvegarde de vos portefeuilles.',
HELP_8CX_Desc_3             : 'Si, pour une raison quelconque, OGPWallet CX disparaissait du Chrome Store, vous pourrez en trouver le source sur [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages) et le charger manuellement. Voir #5 ci-dessus.',
...
HELP_12_Title               : '12) Comment puis-je importer un portefeuille créé par OGPWallet dans geth, Ethereum Wallet ou Mist ?',
HELP_12_Desc_1              : 'Avec un fichier Geth/Mist JSON de OGPWallet v2+.... ',
...
HELP_SecCX_Title            : 'Sécurité - OGPWallet CX',
...
HELP_SecCX_Desc_6           : 'Si nous devions chiffrer ces informations, il vous faudrait entrer un mot de passe à chaque fois que vous voudriez voir votre solde ou les surnoms. Si cela vous ennuie, nous vous recommandons d\'utiliser OGPWallet.com au lieu de cette extension Chrome.',
...
HELP_Sec_Desc_2             : 'Nous avons commencé en août 2015. Si vous recherchez ["OGPWallet" sur reddit](https://www.reddit.com/search?q=OGPWallet), vous pouvez voir qu\'un nombre considérable de personnes nous utilisent sans problème. ',
...
HELP_Sec_Desc_4             : 'Vérifiez l\'URL -- Ce site est servi par Github (et vous pouvez en voir le code source ici : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages)) vers [https://www.OGPWallet.com](https://www.OGPWallet.com).',
