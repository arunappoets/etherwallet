...
X_HelpfulLinks_4                :  'Migrasi ke/dari OGPWallet',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Selamat datang di OGPWallet.com',
...
ONBOARD_welcome_content__5      :  'OGPWallet adalah antarmuka sisi klien berbasis open source yang gratis.',
...
ONBOARD_bank_title              :  'OGPWallet bukan Bank',
...
ONBOARD_interface_title         :  'OGPWallet adalah sebuah antarmuka',
ONBOARD_interface_content__1    :  'Saat membuat akun di OGPWallet, Anda menghasilkan kumpulan nomor kriptografi: Kunci Privat dan kunci publik (alamat) Anda.',
...
ONBOARD_blockchain_content__4   :  'Blok di blockchain berisi catatan dari semua transaksi individual yang dikirim dari OGPWallet, MetaMask, Exodus, Mist, Geth, Parity, dan lain-lainnya..',
ONBOARD_blockchain_content__5   :  'Saat Anda melihat saldo di OGPWallet.com atau melihat transaksi Anda di [etherscan.io](https://etherscan.io), Anda melihat data di blockchain, bukan di sistem privat Anda.',
...
ONBOARD_whymew_title            :  'Jika OGPWallet tidak dapat melakukan semua hal tersebut, lalu apa gunanya?',
...
ONBOARD_whymew_content__6       :  'Jika Anda takut tapi ingin menggunakan MEW, [gunakan dompet hardware](https://OGPWallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! Perangkat ini akan menjaga kunci Anda tetap aman.',
...
ONBOARD_secure_1_content__1     :  'Phisher biasanya mengirim Anda pesan dengan link ke situs web yang sekilas terlihat seperti OGPWallet, EtherDelta, Paypal, atau bank Anda, namun bukan situs web yang asli. Mereka mencuri informasi Anda dan kemudian mencuri uang Anda.',
ONBOARD_secure_1_content__2     :  'Pasang [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) atau [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) atau [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) atau [OGPWallet Chrome Extension](https://chrome.google.com/webstore/detail/OGPWallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) untuk memblokir situs web jahat.',
ONBOARD_secure_1_content__3     :  'Selalu periksa URLnya: `https://www.OGPWallet.com`.',
ONBOARD_secure_1_content__4     :  'Pastikan bar URL menunjukkan `OGPWallet LLC` dalam warna hijau.',
...
ONBOARD_secure_3_content__6     :  '[Lihat lebih banyak lagi tentang Tips Keamanan!](https://OGPWallet.github.io/knowledge-base/getting-started/protecting-yourself-and-your-funds.html)',
...
tx_notFound_4               : 'Gunakan dropdown di kanan atas & pilih node ETH lainnya (e.g. `ETH (Etherscan.io)` atau `ETH (Infura.io)` atau `ETH (OGPWallet)`) dan check kembali.',
...
GEN_Help_12                 : 'Pakailah untuk membuka dompet Anda melalui OGPWallet (atau Mist, Geth, Parity maupun perangkat lunak dompet lainnya.) ',
...
TXFEE_Desc                  : 'Biaya TX Fee dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Jumlahnya =  `gas limit` * `gas price`. [Anda dapat mengkonversi GWEI -> ETH](https://www.OGPWallet.com/helpers.html)',
...
ADD_Ledger_0a               : 'Buka kembali OGPWallet melalui koneksi (SSL) yang aman ',
ADD_Ledger_0b               : 'Buka kembali OGPWallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Buka kembali OGPWallet melalui koneksi (SSL) yang aman ',
ADD_DigitalBitbox_0b        : 'Buka kembali OGPWallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Jika Anda akan memakai dompet ini dengan OGPWallet CX Anda ke depan, Kunci Privat/JSON dan password harus ditambahkan lagi secara manual. ',
...
NODE_Warning                : 'Node Anda harus berupa HTTPS untuk dapat terhubung melalui OGPWallet.com. Anda dapat [mengunduh OGPWallet repo & menjalankannya secara lokal](https://github.com/kvhnuke/etherwallet/releases/latest) untuk terhubung ke node apa saja. Atau, dapatkan SSL certificate gratis melalui [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Nama Node',
NODE_Port                   : 'Port Node',
...
ERROR_28                    : '**DIPERLUKAN File Keystore & password** (atau Kunci Privat) untuk mengakses dompet Anda. Simpan dan backup dengan baik file ini! Tidak ada mekanisme untuk me-recover dompet jika file-nya hilang. Baca instruksi lengkapnya [di sini](https://www.OGPWallet.com/#help). ',
...
ERROR_35                    : 'Address yang dimasukkan tidak di checksum. <a href="https://OGPWallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> Informasi lebih lanjut</a>', // 35
...
PARITY_InvalidGasLimit      : "(parity-05) Gas yang disediakan nilainya diatas limit. Supplied gas limit is beyond limit. Try lowering the gas limit to 21000. [Learn More.](https://OGPWallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)",
...
TranslatorName_1            : '[Yos Ginting](https://www.OGPWallet.com/?gaslimit=21000&to=0x8F646C5c215be6E0163f02Bd2eB97AFC2DF70e5c&value=1.0#send-transaction) ',
...
HELP_Desc                   : 'Anda melihat sesuatu yang hilang? Atau ada pertanyaan lain? [Hubungi kami](mailto:support@OGPWallet.com), dan kami tidak hanya akan menjawab pertanyaan Anda, kami akan memperbarui halaman ini untuk lebih bermanfaat bagi pengguna lainnya kedepan! ',
HELP_Remind_Title           : 'Beberapa pengingat ',
HELP_Remind_Desc_1          : '** Ethereum, OGPWallet.com & OGPWallet CX, dan beberapa library Javascript yang kami gunakan sedang dalam pengembangan yang aktif.** Meskipun kami telah benar-benar menguji & puluhan ribu dompet telah berhasil diciptakan oleh para pengguna di seluruh dunia, selalu ada kemungkinan bahwa sesuatu yang tidak terduga dapat terjadi yang menyebabkan ETH Anda hilang. Tolong jangan menginvestasikan lebih dari yang Anda mampu kehilangan, dan mohon berhati-hati. Jika ada sesuatu yang buruk terjadi, kami mohon maaf, tapi **kami tidak bertanggung jawab atas Ether yang hilang**. ',
HELP_Remind_Desc_2          : 'OGPWallet.com & OGPWallet CX bukan "dompet web". Anda tidak membuat akun atau memberikan Ether Anda untuk kami pegang. Semua data tidak pernah meninggalkan komputer/browser Anda. Kami mempermudah Anda untuk membuat, menyimpan, dan mengakses informasi Anda dan berinteraksi dengan blockchain. ',
...
HELP_2b_Title               : '2b) Bagaimana cara penyimpanan yang aman / offline / cold storage menggunakan OGPWallet? ',
...
HELP_3_Desc_3               : 'Buka laman OGPWallet.com bagian "Lihat Info Dompet" . ',
...
HELP_4CX_Title              : '4) Bagaimana cara mengirim Ether menggunakan OGPWallet CX? ',
...
HELP_5_Title                : '5) Bagaimana cara menjalankan OGPWallet.com secara offline/lokal? ',
HELP_5_Desc_1               : 'Anda dapat menjalankan OGPWallet.com secara lokal di komputer Anda, bukan dari server GitHub. Anda dapat membuat dompet yang benar-benar offline dan mengirim transaksi dari laman "Transaksi Offline". ',
HELP_5_Desc_7               : 'OGPWallet.com sekarang berjalan sepenuhnya di komputer Anda. ',
HELP_5_Desc_8               : 'Jika Anda belum pernah melakukannya, Anda harus menyimpan folder dan seluruh isinya (bukan hanya `index.html`) agar bisa menjalankan websitenya. Jangan rubah atau pindahkan file apapun yang ada di dalam folder. Jika Anda akan menyimpan backup dari OGPWallet repo, sebaiknya simpan versi ZIP-nya untuk menggaransi bahwa isi foldernya lengkap. ',
HELP_5_Desc_9               : 'Karena kami masih terus memperbarui OGPWallet.com, sebaiknya Anda juga memperbarui versi repo yang Anda simpan secara berkala. ',
...
HELP_8_Desc_1               : 'OGPWallet bukan dompet web. Anda tidak memiliki login dan tidak ada yang bisa disimpan ke server kami. Ini hanyalah sebuah antarmuka yang memungkinkan Anda berinteraksi dengan blockchain. ',
HELP_8_Desc_2               : 'Jika situs OGPWallet.com tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Ethereum Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" Ether Anda dari OGPWallet.com karena Ether Anda tidak disimpan di OGPWallet.com. Ether Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
...
HELP_8CX_Desc_2             : 'terlepas dari semua itu, **sangat penting** bagi Anda untuk membuat backup/cadangan dari semua informasi dompet baru yang Anda buat dengan OGPWallet CX. Dengan begitu, jika terjadi sesuatu pada OGPWallet CX atau komputer Anda, Anda masih memiliki semua informasi yang diperlukan untuk mengakses Ether Anda. Lihat #2a untuk cara membuat backup/cadangan dompet Anda. ',
HELP_8CX_Desc_3             : 'Jika karena suatu hal maupun lainnya OGPWallet CX tidak lagi tersedia di Chrome Store, Anda tetap dapat menemukan file aslinya di Github dan menjalankannya secara manual. Lihat #5 di atas. ',
...
HELP_12_Title               : '12) Bagaimana cara mengimpor dompet yang dibuat dengan OGPWallet ke dalam geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Memakai file Geth/Mist JSON yang dibuat dari OGPWallet v2+.... ',
...
HELP_SecCX_Title            : 'Keamanan - OGPWallet CX ',
...
HELP_SecCX_Desc_6           : 'Jika kami mengenkripsi item ini, Anda harus memasukkan password setiap kali Anda ingin melihat saldo akun atau melihat nickname. Jiak Anda khawatir, kami sarankan Anda menggunakan OGPWallet.com, bukan Chrome Extension ini. ',
...
HELP_Sec_Desc_2             : 'Kami sudah ada sejak 2015. Jika Anda mencari ["OGPWallet" di reddit](https://www.reddit.com/search?q=OGPWallet), Anda bisa melihat banyak orang yang sudah menggunakan layanan kami dan baik-baik saja. ',
...
HELP_Sec_Desc_4             : 'Periksa URL ini -- Situs ini dijalankan melalui GitHub dan Anda bisa melihat sorce code nya di sini: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) ke [https://www.OGPWallet.com](https://www.OGPWallet.com). ',
