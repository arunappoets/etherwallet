...
X_HelpfulLinks_4                :  'MyEtherWalletから、またはそれに向けて移管中', /*Migrating to/from OGPWallet*/
...
/* Onboarding */
ONBOARD_welcome_title           :  'いらっしゃいませ！ OGPWallet.com へようこそ！', /*Welcome to OGPWallet.com*/
...
ONBOARD_welcome_content__5      :  'MyEtherWalletはソースコード公開で、クライアント側にある無料で共用の利用者窓口です。', /*OGPWallet is a free, open-source, client-side interface.*/
...
ONBOARD_bank_title              :  'MyEtherWalletは金融機関にあらず　', /*OGPWallet is not a Bank*/
...
ONBOARD_interface_title         :  'MyEtherWalletは、共用の利用者窓口　', /*OGPWallet is an Interface*/
ONBOARD_interface_content__1    :  'MyEtherWalletを使って口座を作る時、一対の暗号のための二つの長い数字、すなわち秘密鍵と公開鍵（アドレス）とが作成されます。', /*When you create an account on OGPWallet you are generating a cryptographic set of numbers: your private key and your public key (address).*/
...
ONBOARD_blockchain_content__4   :  'ブロックチェーンのなかのブロックはMyEtherWallet, MetaMask, Exodus, Mist, Geth, Parityなど至る所で行われている個々の処理や取引で作られています。', /*The blocks in the blockchain are made up of all the individual transactions sent from OGPWallet, MetaMask, Exodus, Mist, Geth, Parity, and everywhere else.*/
ONBOARD_blockchain_content__5   :  'MyEtherWalletや[etherscan.io](https://etherscan.io)で残高や処理を見た時、見えるのは私たちのシステムの中ではなく、ブロックチェーンにあるデータです。', /*When you see your balance on OGPWallet.com or view your transactions on [etherscan.io](https://etherscan.io), you are seeing data on the blockchain, not in our personal systems.*/
...
ONBOARD_whymew_title            :  'MyEtherWalletにできないなら、どうすればいいの？', /*If OGPWallet can\'t do those things, what\'s the point?*/
...
ONBOARD_whymew_content__6       :  'もし、少し不安だけれどもＭＥＷを使いたければ、[ハードウェアワレットを入手(英語)](https://OGPWallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)！', /*If you are scared but want to use MEW, [get a hardware wallet](https://OGPWallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.*/
...
ONBOARD_secure_1_content__1     :  'オンライン詐欺師は、OGPWallet、EtherDelta、Paypalやあなたの金融機関のリンクが含まれた個人メッセージを送りつけてきますが、これは偽のサイトです。あなたの情報を盗み、そして資産を盗みます。', /*Phishers send you a message with a link to a website that looks just like OGPWallet, EtherDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.*/
ONBOARD_secure_1_content__2     :  '[EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn)または[MetaMask](https://OGPWallet.github.io/knowledge-base/migration/moving-from-private-key-to-metamask.html) or [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige). のクローム拡張を使って、これらの悪意のサイトを遮断してください。', /*Install [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) or [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) or  or the [OGPWallet Chrome Extension](https://chrome.google.com/webstore/detail/OGPWallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) to block malicious websites.*/
ONBOARD_secure_1_content__3     :  'いつも、必ず、ＵＲＬ：「https://www.OGPWallet.com」を確認してください。', /*Always check the URL: `https://www.OGPWallet.com`.*/
ONBOARD_secure_1_content__4     :  'ＵＲＬバーに、 `OGPWallet LLC`と緑色で表示されていることを必ず確認してください。', /**/
...
ONBOARD_secure_3_content__6     :  '[さらに安全確保のためのセキュリティ情報！](https://OGPWallet.github.io/knowledge-base/getting-started/protecting-yourself-and-your-funds.html)', /*[Even more Security Tips!](https://OGPWallet.github.io/knowledge-base/getting-started/protecting-yourself-and-your-funds.html)*/
...
ADD_Secalot_0a              : 'Re-open OGPWallet on a secure (SSL) connection ',
ADD_Secalot_0b              : 'Re-open OGPWallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
ERROR_28                    : '(error_29) お財布を操作するためには**Keystore/JSONとパスワードか秘密鍵が必要** 保存してから、外部バックアップしてください！ここで保存しないとお財布が使用できなくなります。詳細はヘルプページを参照してください。(https://www.OGPWallet.com/#help) (You need this `Keystore File + Password` or the `Private Key` (next page) to access this wallet in the future. ) ',
...
ERROR_35                    : '(error_36) チェックサムが付いていません。 <a href="https://OGPWallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> 詳細</a (Input address is not checksummed. <a href="https://OGPWallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer">What does that mean?</a>)>',
...
GETH_Nonce                  : '(geth-08) Nonce が足りません This TX\'s [nonce](https://OGPWallet.github.io/knowledge-base/transactions/what-is-nonce.html) is too low. Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://OGPWallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html).',
GETH_NonExistentAccount     : '(geth-09) アカウントが存在しない、あるいはその残高不足です Account does not exist or account balance too low',

PARITY_AlreadyImported      : "(parity-01) 同じハッシュのトランザクションがすでにインポートされています。 A transaction with the same hash was already imported. It was probably already broadcast. To avoid duplicate transactions, check your address on [etherscan.io](https://etherscan.io) & wait 10 minutes before attempting to send again. [Learn More.](https://OGPWallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
...
PARITY_InsufficientBalance  : "(parity-03) ファンドが足りません。 トランザクション送出元のファンドが不足しています。 必要量 {} で 現在： {}　　です。 Insufficient balance. The account you tried to send transaction from does not have enough funds. If you believe this is in error, try using the 'Send Entire Balance' button, or pressing generate again. Required (d+) and got: (d+). [Learn More.](https://OGPWallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
PARITY_InsufficientGasPrice : "(parity-04) トランザクションフィー不足です。 ノードの最小 fee を満たしていません。 (minimal: {}, got: {}). fee を増やしてください。 There is another transaction with same nonce in the queue, or the transaction fee is too low. Try incrementing the nonce by clicking the Generate button again. [Learn More.](https://OGPWallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
PARITY_InvalidGasLimit      : "(parity-05) ガス供給量が制限を超過しています。 Supplied gas limit is beyond limit. Try lowering the gas limit to 21000. [Learn More.](https://OGPWallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)",
PARITY_LimitReached         : "(parity-06) キューにあるトランザクションの数が多すぎます。上限を超えたため、対象のトランザクションは除外されています。その fee を増やしてみてください。 There are too many transactions in the queue. Your transaction was dropped due to limit. Try increasing the gas price. [Learn More.](https://OGPWallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
PARITY_Old                  : "(parity-07) トランザクション nonceが小さすぎます。増やしてみてください。 There is already a transaction with this [nonce](https://OGPWallet.github.io/knowledge-base/transactions/what-is-nonce.html). Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://OGPWallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html).",
PARITY_TooCheapToReplace    : "(parity-08) トランザクションフィー不足です。同じ nonce のトランザクションが別のキューにあります。fee または nonce を増やしてみてください。 TX Fee is too low. It does not satisfy your node's minimal fee (minimal: (d+), got: (d+)). Try increasing the gas price and/or gas limit. [Learn More.](https://OGPWallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
...
GEN_Help_12                 : 'MyEtherWalletの上でこれを使って自分のお財布をアンロックしてください（Mist, Geth, Parityや他のお財布クライアントも可）', /*Use it to unlock your wallet via OGPWallet (or Mist, Geth, Parity and other wallet clients.)*/
...
MYWAL_Content_3             : 'OGPWallet CXでこのお財布を使用するためには、秘密鍵あるいはJSONとパスワードを手動で追加する必要があります。 ',
...
NODE_Warning                : 'OGPWallet.com 経由で接続するためには、HTTPSノードが必要です。[MyEtherWalletをレポジトリからダウンロードして、手元で走らせ、](https://github.com/kvhnuke/etherwallet/releases/latest)いずれかのノードに接続することもできます。 あるいは、無料のSSL証明書を[LetsEncrypt](https://letsencrypt.org/)から入手してください',
NODE_Name                   : 'ノード名',
NODE_Port                   : 'ノードポート',
...
tx_FoundOnChain_3           : '**何もエラーメッセージが返ってこなければ、あなたの処理は正しく送出されています。** ETHあるいはトークンは、送ろうとしたあて先の場所にあります。 もし、ETHやトークンが他のお財布や交換所のお財布に見つからず、処理を開始してから２４時間以上経っていたら、 [そのサービスに連絡](https://OGPWallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html)してください。状況を確認してもらうために、自分の処理のリンクをうまく知らせてください。',
...
tx_notFound_4               : '右上の下展開メニューから、別のノードを選択してください。 (例： `ETH (Etherscan.io)` or `ETH (Infura.io)` or `ETH (OGPWallet)`) から選んで再度確認する。',
tx_Summary                  : '数日後に処理状況を確認した場合をのぞいて、大量の処理発生時(ICO期間など)には、数時間処理が遅れる場合があります。本ツールは、そのような状況において処理待ちの処理を探し出し取り消す、あるいは更新する機能を提供します。＊＊これは特殊な操作で、処理プールが満杯の場合にのみ有効です。  [このツールに関しては、こちらを参考にしてください。](https://OGPWallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html)**',

TXFEE_Desc                  : 'この処理料金は自分の処理をブロックに配置するためにマイナーに支払われます。「ガスリミット」＊「ガス価格」で算出されます。 [GWEI -> ETHの単位変換はこちらです。](https://www.OGPWallet.com/helpers.html)',　/*The TX Fee is paid to miners for including your TX in a block. It is the `gas limit` * `gas price`. [You can convert GWEI -> ETH here](https://www.OGPWallet.com/helpers.html)*/
...
HELP_0_Desc_1               : 'OGPWallet gives you the ability to generate new wallets so you can store your Ether yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**. ',
...
HELP_2b_Title               : '2b) How do I safely / offline / cold storage with OGPWallet? ',
...
HELP_3_Desc_3               : 'Navigate to the OGPWallet.com "View Wallet Info" page. ',
...
HELP_4CX_Title              : '4) How do I send Ether using OGPWallet CX? ',
...
HELP_5_Title                : '5) How do I run OGPWallet.com offline/locally? ',
HELP_5_Desc_1               : 'You can run OGPWallet.com on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page. ',
HELP_5_Desc_7               : 'OGPWallet.com is now running entirely on your computer. ',
HELP_5_Desc_8               : 'In case you are not familiar, you need to keep the entire folder in order to run the website, not just `index.html`. Don\'t touch or move anything around in the folder. If you are storing a backup of the OGPWallet repo for the future, we recommend just storing the ZIP so you can be sure the folder contents stay intact. ',
HELP_5_Desc_9               : 'As we are constantly updating OGPWallet.com, we recommend you periodically update your saved version of the repo. ',
...
HELP_8_Desc_1               : 'OGPWallet is not a web wallet. You don\'t have a login and nothing ever gets saved to our servers. It is simply an interface that allows you interact with the blockchain. ',
HELP_8_Desc_2               : 'If OGPWallet.com goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Ether out of OGPWallet because it\'s not in OGPWallet. It\'s in whatever wallet your generated via our site. ',
...
HELP_8CX_Desc_2             : 'That said, it is **very important** that you back up all your information for any new wallets generated with OGPWallet CX. That way if anything happens to OGPWallet CX or your computer, you still have all the information necessary to access your Ether. See the #2a for how to back up your wallets. ',
HELP_8CX_Desc_3             : 'If for some reason OGPWallet CX disappears from the Chrome Store, you can find the source on Github and load it manually. See #5 above. ',
...
HELP_12_Title               : '12) How do I import a wallet created with OGPWallet into geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Using an Geth/Mist JSON file from OGPWallet v2+.... ',
...
HELP_14_Title               : '14) Some sites randomize (seed) the private key generation via mouse movements. OGPWallet.com doesn\'t do this. Is the random number generation for OGPWallet safe? ',
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, OGPWallet.com can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_Desc                   : 'Do you see something missing? Have another question? [Get in touch with us](mailto:support@OGPWallet.com), and we will not only answer your question, we will update this page to be more useful to people in the future! ',
HELP_Remind_Title           : 'Some reminders ',
HELP_Remind_Desc_1          : '**Ethereum, OGPWallet.com & OGPWallet CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost Ether**. ',
HELP_Remind_Desc_2          : 'OGPWallet.com & OGPWallet CX are not "web wallets". You do not create an account or give us your Ether to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain. ',
...
HELP_SecCX_Title            : 'Security - OGPWallet CX ',
...
HELP_SecCX_Desc_6           : 'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use OGPWallet.com instead of this Chrome Extension. ',
...
HELP_Sec_Desc_2             : 'We\'ve been up and running since August 2015. If you search for ["OGPWallet" on reddit](https://www.reddit.com/search?q=OGPWallet), you can see numerous people who use us with great success. ',
...
HELP_Sec_Desc_4             : 'Check the URL -- This site is being served through GitHub and you can see the source code here: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) to [https://www.OGPWallet.com](https://www.OGPWallet.com). ',
