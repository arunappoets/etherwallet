...
MYWAL_Content_3             : 'Если Вы планируете в будущем использовать этот кошелёк в OGPWallet CX, Вам надо будет вручную заново добавить его, указав закрытый ключ или файл JSON и пароль. ',
...
NODE_Warning                : 'Ваш узел должен использовать протокол HTTPS, чтобы OGPWallet.com мог с ним работать. Вы можете [скачать репозиторий OGPWallet & и запустить его локально](https://github.com/kvhnuke/etherwallet/releases/latest) чтобы иметь возможность работать с любыми узлами, или получите бесплатный SSL сертификат на [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Имя узла',
NODE_Port                   : 'Порт узла',
...
ADD_Ledger_0a               : 'Перезапустите OGPWallet через безопасное (SSL) соединение ',
ADD_Ledger_0b               : 'Перезапустите OGPWallet с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Перезапустите OGPWallet через безопасное (SSL) соединение ',
ADD_DigitalBitbox_0b        : 'Перезапустите OGPWallet с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
...
TranslatorName_1            : '[Михаил Владимиров](https://www.OGPWallet.com/?gaslimit=21000&to=0x6ff323e36bfdb20502b23780695f4e77e36cde95&value=1.0#send-transaction) ',
