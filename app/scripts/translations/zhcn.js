...
/* Onboarding */
ONBOARD_welcome_title           :  '欢迎使用 OGPWallet.com',
...
ONBOARD_welcome_content__5      :  'OGPWallet 是一款免费, 开源的钱包客户端.',
...
ONBOARD_bank_title              :  'OGPWallet 不是银行',
...
ONBOARD_interface_title         :  'OGPWallet 只是操作接口',
ONBOARD_interface_content__1    :  '当你在OGPWallet创建账户的时候, 实际上只是生成了一对具备密码学意义的数字串: 你账户的私钥和公钥(地址).',
...
ONBOARD_blockchain_content__5   :  '当你使用 OGPWallet.com 查看余额, 或者使用 [etherscan.io](https://etherscan.io)查看交易详细信息时, 这些显示的信息都是直接来自区块链网络, 而不是来自MEW的独立系统.',
ONBOARD_blockchain_content__6   :  '再次申明: **OGPWallet不是银行**.',
...
ONBOARD_whymew_title            :  '如果OGPWallet都不能做前面说的那些事, 那我为啥还要用它?',
...
ONBOARD_whymew_content__6       :  '如果你担心 MEW 还不够安全, [那就赶紧买个硬件钱包吧](https://OGPWallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! 它们能保证你密钥的安全.',
ONBOARD_why_title__alt          :  '但是为啥呢?',
ONBOARD_secure_title            :  '如何保护你的隐私和资金安全',
ONBOARD_secure_1_title          :  '如何防范钓鱼网站',
ONBOARD_secure_1_content__1     :  '钓鱼网站的常用伎俩是向你发送一条包含网站链接的信息, 并将这个链接伪装成很像OGPWallet, EtherDelta, Paypal或者银行的网站.当用户访问这些钓鱼网站并不慎填写自己的账户信息后, 黑客就能窃取这些信息进而窃取你的资金.',
ONBOARD_secure_1_content__2     :  '可以安装 [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) 或者 [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) 或者 [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) 或者 [OGPWallet Chrome Extension](https://chrome.google.com/webstore/detail/OGPWallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) 这几个可以防范钓鱼网站的插件.',
ONBOARD_secure_1_content__3     :  '记得每次都要检查 URL 地址: `https://www.OGPWallet.com`.',
ONBOARD_secure_1_content__4     :  '正常情况下地址栏左侧会始终显示 `OGPWallet LLC` 字样的绿色字体.',
...
ONBOARD_secure_3_content__6     :  '[点我查看更多安全技巧!](https://OGPWallet.github.io/knowledge-base/getting-started/protecting-yourself-and-your-funds.html)',
...
sidebar_donation            : 'OGPWallet是保护你的隐私和安全的免费、开源服务。 我们收到的捐赠越多，我们开发新特性、听取你的反馈的时间就越多。我们只是两个尝试改变世界的两个开发者。您能帮助我们吗？ ',
sidebar_donate              : '捐赠 ',
sidebar_thanks              : '感谢你！！！ ',
...
MYWAL_Content_3             : '如果你想将来在OGPWallet插件中使用该钱包，你需要手动添加私钥/JSON文件和密码。 ',
...
ERROR_28                    : '将来使用钱包时，你需要Keystore文件或者私钥。 请做好保存和备份。 如果你没有保存，没有办法恢复钱包。 请阅读[帮助页面](https://www.OGPWallet.com/#help)，获得更多信息。 ',
...
TranslatorName_1            : '[ Shaoping@ethfans.org （少平）]((https://www.OGPWallet.com/?gaslimit=21000&to=0x4dF5698B1B0195FC44Fe1D2d6037CE33F215c740&value=1.0#send-transaction)) ',
TranslatorAddr_1            : '0x4dF5698B1B0195FC44Fe1D2d6037CE33F215c740 ',
/* Translator 1             : Insert Comments Here */
TranslatorName_2            : '[ Wenham@coinwallet.shop (文翰) ]((https://www.OGPWallet.com/?gaslimit=21000&to=0x0D2dC3fD9463a7CeBE5f1b946c2D7cF5c3e82127&value=0.1#send-transaction))',
